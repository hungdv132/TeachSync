...
(
    ...
    `startAt`     DATETIME    NOT NULL COMMENT 'Bắt đầu làm lúc nào',
    `submitAt`    DATETIME    NULL DEFAULT NULL COMMENT 'Nộp bài lúc nào',
    `score`       DOUBLE      NULL DEFAULT NULL COMMENT 'Bao nhiêu điểm (max = 10.00) (Auto tính = code. Giáo viên update nếu bài test.QuestionType = ESSAY)',
    `status`      VARCHAR(45) NOT NULL,
    `createdAt`   DATETIME    NULL DEFAULT NULL,
    `createdBy`   BIGINT      NULL DEFAULT NULL,
    `updatedAt`   DATETIME    NULL DEFAULT NULL,
