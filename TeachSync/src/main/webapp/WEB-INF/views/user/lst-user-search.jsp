    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="d-flex align-items-center mb-3">
                <a href="/searchuserbyusername?page=0&searchText=${searchText}" class="btn btn-secondary"><i class="bi-chevron-bar-left"></i></a>
                <a href="/searchuserbyusername?page=${pageNo-1}&searchText=${searchText}" class="btn btn-secondary mx-2"><i class="bi-chevron-left"></i></a>
                Page: <c:out value="${pageNo + 1}"/> &sol; <c:out value="${pageTotal}"/>
                <a href="/searchuserbyusername?page=${pageNo + 1}&searchText=${searchText}" class="btn btn-secondary mx-2"><i class="bi-chevron-right"></i></a>
                <a href="/searchuserbyusername?page=${pageTotal-1}&searchText=${searchText}" class="btn btn-secondary"><i class="bi-chevron-bar-right"></i></a>
            </div>
        </div>
    </div>
</div>
