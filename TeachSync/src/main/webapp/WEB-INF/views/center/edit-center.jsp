  ...
  <div class="col">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb ts-txt-sm ts-txt-bold my-2">
        ...
        <li class="breadcrumb-item">
          <a href="/center-detail?id=${center.id}">Chi tiết Cơ sở</a>
        </li>
...
<div class="row ts-bg-white border ts-border-teal rounded-3 pt-3 px-5 mx-2 mb-3">
  <form class="col-12" id="form" action="/edit-center" method="POST">
    <div class="row mb-3">
      <h4>Sửa Cơ Sở</h4>
      <br>
      ...
      <div class="col-sm-12 col-md-8 mb-3">
        ...
        <div class="row mb-3">
          <label class="col-4">Tên trung tâm: <br/>
            <input class="w-100" type="text"
                   id="centerName" name="centerName" value="${center.centerName}">
          </label>
          ...
          <label class="col-4">Số phòng: <br/>
            <input class="w-100" type="number" min="1" max="999"
                   id="centerSize" name="centerSize" value="${center.centerSize}">
          </label>
        </div>
        ...
        <div class="row">
          <label class="col-6 mb-3">Số: <br/>
            <input class="w-100"
                   id="txtAddrNo" name="addressNo" value="${center.address.addressNo}">
          </label>
          <label class="col-6 mb-3">Đường: <br/>
            <input class="w-100"
                   id="txtStreet" name="street" value="${center.address.street}">
          </label>
      ...
      <div class="col-12 d-flex justify-content-center">
        <button type="button" id="submit" class="btn btn-primary w-50" onclick="updateCenter()">Chỉnh sửa</button>
      </div>
    </div>
  </form>
</div>
