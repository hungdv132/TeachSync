...
<div class="row">
  ...
  <div class="col-12 ts-bg-white border-top border-bottom ts-border-teal pt-3 px-5 mb-3">
    <%--@elvariable id="updateDTO" type="com.teachsync.dtos.clazzSchedule.ClazzScheduleUpdateDTO"--%>
    <form:form id="form"
               modelAttribute="updateDTO" action="/edit-schedule" method="post"
               class="row">
      ...
      <div class="col-sm-6 col-md-4 mb-3">
        ...
        <input id="dateStart" name="startDate"
               type="date" min="${schedule.startDate}" max="" value="${schedule.startDate}"
               class="form-control"
               onchange="checkSchedule()"
               required="required">
      </div>
      ...
      <div class="col-sm-6 col-md-4 mb-3">
        ...
        <input id="dateEnd" name="endDate"
               type="date" min="${schedule.endDate}" max="" value="${schedule.endDate}"
               class="form-control"
               onchange="checkSchedule()"
               required="required">
      </div>
