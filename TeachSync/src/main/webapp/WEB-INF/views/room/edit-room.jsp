  ...
  <div class="col">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb ts-txt-sm ts-txt-bold my-2">
        ...
        <li class="breadcrumb-item">
          <a href="/list-room">Danh sách Phòng học</a>
        </li>
        <li class="breadcrumb-item">
          <a href="/room-detail?id=${room.id}">Chi tiết Phòng Học</a>
        </li>
...
<div class="row ts-bg-white border ts-border-teal rounded-3 pt-3 px-5 mx-2 mb-3">
  <form class="col-12" id="form" action="/edit-room" method="POST">
    <div class="row mb-3">
      <h4>Sửa Phòng Học</h4>
      <br>
        ...
        <div class="row mb-3">
          <label class="col-4">Tên phòng: <br/>
            <input class="w-100" type="text"
                   id="roomName" name="roomName" value="${room.roomName}">
          </label>
      ...
      <div class="col-12 d-flex justify-content-center">
        <button type="button" id="submit" class="btn btn-primary w-50">Chỉnh sửa</button>
      </div>
    </div>
  </form>
</div>
